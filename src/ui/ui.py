...
class UI:
    ...
    def _show_login_view(self):
        ...
        self._current_view = LoginView(self._root, self._handle_create_account, self._handle_expense_tracker)
        self._current_view.configure()
    
    def _show_create_account_view(self):
        self._hide_current_view()

        self._current_view = CreateAccountView(self._root, self._handle_expense_tracker, self._handle_login)
        self._current_view.configure()
