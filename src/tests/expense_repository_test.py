...
class TestExpenseRepository(unittest.TestCase):
    ...
    def test_add_expense(self):
        ...
        if found:
            found_expense=[found["username"], found["name"], found["amount"], found["date"], found["category"]]
    ...
    def test_get_all_expenses_by_category_and_user(self):
        ...
        found = test_repository.get_all_expenses_by_category_and_user(self.test_user, test_category)
